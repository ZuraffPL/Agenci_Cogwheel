...
class CogwheelActorSheetV2 extends foundry.applications.sheets.ActorSheet {
...
foundry.documents.Actors.registerSheet("cogwheel-syndicate", CogwheelActorSheetV2, {
  types: ["agentv2"],
  makeDefault: true,

...
console.log("Cogwheel v2: Selected BaseActorSheet:", BaseActorSheet.name);

class CogwheelActorSheetV2 extends BaseActorSheet {
...
CHLOPCYCONFIG_V2.Actors.registerSheet("cogwheel-syndicate", CogwheelActorSheetV2, {
  types: ["agentv2"],
  makeDefault: true,
